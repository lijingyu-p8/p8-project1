...
Caffeine是基于JAVA 1.8 的高性能缓存库。Caffeine提供的内存缓存使用参考Google guava的API。Caffeine是基于Google Guava Cache设计经验上改进的成果。

使用起来和guava cache用法一致，不过相较于guava，Caffeine可以通过封装实现随机过期时间。
